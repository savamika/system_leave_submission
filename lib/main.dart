...
import 'package:systemleavesubmission/pages/splash_page.dart';
import 'package:systemleavesubmission/pages/sign_in.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:systemleavesubmission/firebase_options.dart';
    ...
    return GestureDetector(
        onTap: () {
          signInWithGoogle().then((result) {
            if (result != null) {
              Route route = MaterialPageRoute(builder: (context) => SpashPage(), maintainState: false);
